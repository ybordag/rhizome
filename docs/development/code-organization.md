...
| `session_context.py` | Text-first startup/session context helpers for Verdant: empty/unset response shape, inferred/user source normalization, partial PATCH application, graph-state merge, focus object label resolution, and prompt-summary formatting. |
